...
Serial.println(msgLen);
     ...
     message[9] == 'S' )
    {
        ...
        strip.setBrightness(message[10]);
           Serial.println(message[10], DEC);
    ...
    Serial.println(message[5], DEC);    
    Serial.println(message[6], DEC);    
    Serial.println(message[7], DEC);        
